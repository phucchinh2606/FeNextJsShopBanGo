  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 flex items-center justify-center max-w-7xl w-full mx-auto px-4 py-6 sm:py-12">
        <div className="bg-white p-5 sm:p-10 rounded-2xl sm:rounded-3xl border border-gray-100 shadow-sm max-w-md w-full space-y-5 sm:space-y-6">
          ...
          {errorMsg && (
            <div className="p-3 bg-rose-50 border border-rose-200 text-rose-700 text-xs font-semibold rounded-xl sm:rounded-2xl flex items-center space-x-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-4">
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full py-3 sm:py-3.5 bg-amber-800 hover:bg-amber-900 text-white font-semibold text-xs rounded-xl shadow-lg shadow-amber-900/20 transition flex items-center justify-center space-x-2 disabled:opacity-50"
            >
