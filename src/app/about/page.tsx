            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6 space-y-6">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  ...
                  và phát triển nét đẹp nguyên bản của gỗ tự nhiên trong từng
                  ngôi nhà Việt.
                </p>

                <p className="text-sm text-slate-600 leading-relaxed">
                  Mỗi bộ bàn ghế, giường ngủ hay bàn thờ tại WOODSTORE không đơn
                  thuần là một món đồ dùng, mà là một **tác phẩm nghệ thuật**
                  được các nghệ nhân thổi hồn vào từng đường chạm, đường vân.
                  Chúng tôi tin rằng không gian sống gỗ chuẩn phong thủy sẽ mang
                  lại thịnh vượng và an yên trọn đời cho gia chủ.
                </p>
        ...
        <section className="py-16 bg-gradient-to-r from-amber-900 to-amber-950 text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
            ...
            <p className="text-xs sm:text-sm text-amber-100/80 max-w-2xl mx-auto leading-relaxed">
              Liên hệ ngay với chuyên gia của WOODSTORE để được tư vấn kích
              thước phong thủy, lựa chọn loại gỗ và nhận báo giá ưu đãi tại
              xưởng.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
              ...
              >
                ...
                <span>Tư vấn Hotline: 0972 971 555</span>
              </a>
            </div>
          </div>
        </section>
