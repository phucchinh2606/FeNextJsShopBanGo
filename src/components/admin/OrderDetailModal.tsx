  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white w-full max-w-3xl rounded-2xl shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
          ...
          {isLoading || !order ? (
            ...
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div className="p-3.5 sm:p-4 rounded-xl border border-slate-100 bg-slate-50/50 space-y-2">
                ...
                <div className="border border-slate-200/80 rounded-xl overflow-x-auto">
                  <table className="w-full text-left min-w-[480px]">
                    <thead className="bg-slate-50 text-slate-600 border-b border-slate-200 text-[11px]">
                      <tr>
                        <th className="p-2.5 sm:p-3 font-semibold">Sản phẩm</th>
                        <th className="p-2.5 sm:p-3 font-semibold text-center">
                          Đơn giá
                        </th>
                        <th className="p-2.5 sm:p-3 font-semibold text-center">
                          Số lượng
                        </th>
                        <th className="p-2.5 sm:p-3 font-semibold text-right">
                          Thành tiền
                        </th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-100">
                      {order.orderDetails?.map((item) => (
                        ...
                        >
                          ...
                          <td className="p-2.5 sm:p-3 text-center text-slate-800 font-bold">
                            {item.quantity}
                          </td>
                          <td className="p-2.5 sm:p-3 text-right font-bold text-amber-900">
                  ...
                  <div className="p-3 bg-slate-50 border-t border-slate-200 flex justify-between items-center font-bold">
              ...
              {/* Trạng Thái */}
              <div className="p-3.5 sm:p-4 rounded-xl border border-amber-200/80 bg-amber-50/30 space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      className="w-full p-2 sm:p-2.5 bg-white border border-slate-200 rounded-xl text-xs focus:ring-2 focus:ring-amber-500/20 focus:border-amber-800 outline-none"
                    >
        ...
        <div className="p-3 sm:p-4 border-t border-slate-100 bg-slate-50/50 flex justify-end space-x-2 shrink-0">
          <button
            onClick={onClose}
