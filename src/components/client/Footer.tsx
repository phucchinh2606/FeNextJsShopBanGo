  ...
  return (
    <footer className="bg-amber-950 text-amber-100 border-t border-amber-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-serif font-bold tracking-wider text-white">
            ...
            {/* Social Icons (SVG chuẩn) */}
            <div className="flex space-x-3 pt-2">
              <a
                href="https://facebook.com"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-amber-900/60 flex items-center justify-center hover:bg-amber-600 hover:text-white transition"
                aria-label="Facebook"
              >
          ...
          {/* Cột 2: Danh mục sản phẩm (Động từ API) */}
          <div className="space-y-4">
      ...
      <div className="border-t border-amber-900/60 bg-amber-950/80 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-xs text-amber-300/60">
          <p>
